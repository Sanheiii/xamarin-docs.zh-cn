...
|Mono|安装检查|下载|安装
|---|---|---|---|
||[![缺失 Mono 安装](images/mono-missing.png "缺失 Mono 安装")](images/mono-missing-large.png#lightbox)|[![下载 Mono](images/mono-downloading.png "下载 Mono")](images/mono-downloading-large.png#lightbox)|[![安装 Mono](images/mono-installing.png "安装 Mono")](images/mono-installing-large.png#lightbox)|
...
|Xcode|安装检查|许可证接受|
|---|---|---|
||[![缺失 Xcode 安装](images/xcode-missing.png "缺失 Xcode 安装")](images/xcode-missing-large.png#lightbox)|[![Xcode 许可证](images/xcode-license.png "Xcode 许可证")](images/xcode-license-large.png#lightbox)|
