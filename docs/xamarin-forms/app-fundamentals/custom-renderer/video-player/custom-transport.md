...
不管这些符号在浏览器中是如何显示的（不同的浏览器处理符号的方式不同），它们在 Xamarin.Forms 支持的平台上的显示都会不一致。 在 iOS 和 UWP 设备上，“暂停”和“停止”字符具有蓝色 3D 背景和白色前景的图形外观 。 但在 Android 上却不是这样，它的符号只是蓝色。 但是，“播放”的 0x23F5 码点在 UWP 上没有相同的外观，iOS 和 Android 甚至不支持它。
