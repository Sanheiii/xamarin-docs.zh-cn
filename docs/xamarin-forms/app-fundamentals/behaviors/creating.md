...
- [Xamarin.Forms 行为（示例）](/samples/xamarin/xamarin-forms-samples/behaviors-numericvalidationbehavior)
- [通过样式应用的 Xamarin.Forms 行为（示例）](/samples/xamarin/xamarin-forms-samples/behaviors-numericvalidationbehaviorstyle)
